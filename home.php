...
<div class="d-flex w-100 h-100">
	...
	<div class="center-panel py-3 px-2 my-2">
					...
					<div class="card-body" style="background: #242526">
						<div class="container-fluid">
							<div class="d-flex w-100">
								<div class="rounded-circle mr-1" style="width: 45px;height: 45px;top:-5px;left: -40px">
				                ...
				                <button class="btn btn-default ml-3 text-left" id="write_post" type="button" style="width:calc(95%);border-radius: 50px !important;"><span>&nbsp;Showcase your work, <?php echo ucwords($_SESSION['login_firstname']) ?>!</span></button>
							</div>
							<br>
							<div class="d-flex w-100 justify-content-center" >
								<a href="javascript:void(0)" id="upload_post" class="text-light post-link px-5 py-2" style="border-radius: 40px; background: #18191A !important"><span class="fa fa-photo-video text-success"></span> Photo/Video</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="card card-widget post-card" data-id="<?php echo $row['id'] ?>">
              <div class="card-header" style="background: #242526;">
                <div class="user-block" >
                  ...
                  <span class="username" ><a href="#" style="color:white"><?php echo $row['name'] ?></a></span>
