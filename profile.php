...
<div class="row shadow-sm" id="profile-field">
	<div class="container">
		<div class="col-lg-10 offset-md-1" style="height:50vh">
			...
			<div class="d-block w-100 py-2 px-1 text-center">
				<h2 class="text-light text-center" style="font-size: 50px; padding-top: 1.5rem;"><b><?php echo ucwords($_SESSION['login_firstname'].' '.$_SESSION['login_lastname']); ?></b></h2>
				<small class="text-muted" style="font-size: medium;font-weight:600; color:gray"><?php echo $_SESSION['login_bio'] ?></small>
			</div>
		</div>
	</div>
</div>
		...
		<div class="row">
			<div class="col-md-4" >
				<div class="card card-primary" >
	              <div class="card-header" style="background: #242526">
	                <h3 class="card-title" style="font-weight: bold;">About Me</h3>
	              </div>
		              <!-- /.card-header -->
		              <div class="card-body" style="padding-bottom: 0; background:#242526">
		                <strong class="text-white"><i class="fas fa-map-marker-alt mr-1"></i> Location</strong>

		                <p class="text-white"><?php echo $_SESSION['login_address'] ?></p>

		                <hr>

		                <strong class="text-white"><i class="fas fa-calendar-day mr-1"></i> Date of Birth</strong>

		                <p class="text-white"><?php echo date("M d,Y",strtotime($_SESSION['login_dob'])) ?></p>

		                <hr>

		                <strong class="text-white"><i class="fa fa-phone mr-1"></i> Contact</strong>

		                <p class="text-white"><?php echo $_SESSION['login_contact'] ?></p>
		                <hr>
		                <strong class="text-white"><i class="far fa-user mr-1"></i> Gender</strong>

		                <p class="text-white"><?php echo $_SESSION['login_gender'] ?></p>
		              </div>
		              <!-- /.card-body -->
	            </div>
			</div>
			...
			<div class="card card-widget post-card" data-id="<?php echo $row['id'] ?>">
              ...
              <!-- /.card-header -->
              <div class="card-body" style="background: #242526;">
                <!-- post text -->
                <p class="content-field" style="color: white"><?php echo $row['content'] ?></p>
              ...
              <?php endif; ?>
                ...
                <button type="button" style="background: #242526;border-color:gray; border-style:solid; width:80px; color:white;"class="btn btn-default btn-sm like  <?php echo $is_liked ?>" data-id="<?php echo $row['id'] ?>"><i class="fa fa-thumbs-up"></i>&nbsp;Like</button>
              ...
              <!-- /.card-body -->
              <div class="card-footer card-comments" style="background: #242526;">
				<?php 
				...
				<div class="card-comment">
					...
					<span class="username">
						<span class="uname"style="color:white"><?php echo $crow['name'] ?></span>
              ...
              <!-- /.card-footer -->
              <div class="card-footer" style="background: #242526;">
                <form action="#" method="post">
                  <i class="img-fluid img-circle img-sm fa fa-comment"style="color:white"></i>
